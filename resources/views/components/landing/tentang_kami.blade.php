                ...
                <div class="card p-5 shadow">
                    ...
                    <div class="row align-items-center mt-3">
                        ...
                        <div class="col-md-3 col-sm-12 text-center py-2">
                            ...
                            <a href="{{ route('informasi.prestasi') }}" class=" tentang d-block text-decoration-none fw-bold fs-5 text-muted">Prestasi</a>
                        </div>
                        <div class="col-md-3 col-sm-12 text-center py-2">
                        ...
                        <div class="col-md-3 col-sm-12 text-center py-2">
                            ...
                            <a href="{{ route('akademik.ekstrakurikuler') }}" class=" tentang d-block text-decoration-none fw-bold fs-5 text-muted">Ekstrakulikuler</a>
                        </div>
                    </div>
                </div>
            </div>
